    ...
    <Card className="bg-white">
      ...
      <CardContent className="p-4 pt-0">
        <div className="overflow-x-auto">
          <div className="flex min-w-[42rem] items-start justify-between gap-3 md:min-w-[54rem]">
            {flow.map(([title, copy, Icon], index) => (
              <div key={title} className="contents">
                ...
                {index < flow.length - 1 ? (
                  <ChevronRight className="mt-6 h-4 w-4 shrink-0 text-slate-400" />
                ) : null}
              </div>
            ))}
          </div>
  ...
  return (
    <Card className="bg-white">
      ...
      <CardContent className="overflow-x-auto p-4 pt-0">
        <div className="grid min-w-[36rem] grid-cols-[8.5rem_repeat(4,minmax(0,1fr))] gap-3 md:min-w-[46rem] md:grid-cols-[10rem_repeat(4,minmax(0,1fr))]">
        <div className="rounded-[1.25rem] border-4 border-slate-900 bg-slate-50 p-3">
