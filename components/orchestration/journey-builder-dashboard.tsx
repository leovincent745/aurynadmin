...
function JourneyCanvas() {
  return (
    <Card className="min-w-0 overflow-hidden bg-white">
      ...
      <CardContent className="min-h-[42rem] overflow-x-auto p-4 [background-image:radial-gradient(#dbe4f0_1px,transparent_1px)] [background-size:16px_16px]">
        <div className="mx-auto grid min-w-[46rem] max-w-5xl grid-cols-1 gap-4 lg:grid-cols-9">
